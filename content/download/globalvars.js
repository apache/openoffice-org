...
DL.VERSION			= "4.1.11";		// Release version in full format "x.y.z".
DL.VERSION_SHORT		= DL.VERSION;		// Release version in short format "x.y".
DL.MILESTONE			= "AOO4111m1";		// Milestone ID (from AOO build system).
DL.BUILD			= "9808";		// Build ID (from AOO build system).
DL.SVN_REV			= "bdb20b2a64";		// Git revision.
DL.REL_DATE			= "2021-October-06";	// Date of the public announced release.
DL.PREV_VERSION			= "4.1.10";		// Release of the previous version.
