...
l10n.dl_green_box_select_box_lang_values_custom	= [ "ast",	"Asturianu",				"Asturianu",
						    "eu",	"Basque",				"Euskara",
...
l10n.dl_share_light_blue_box_headline_title	= "Ayude a correr la voz y fale a les amistaes sobre Apache OpenOffice";
l10n.dl_share_light_blue_box_text_text		= "Por favor, fale a les amistaes sobre Apache OpenOffice:";
l10n.dl_share_light_blue_box_text_title		= "Ayude a correr la voz y fale a les amistaes sobre Apache OpenOffice";
l10n.dl_share_light_blue_box_blog_text		= "Blogue";
l10n.dl_share_light_blue_box_blog_title		= "Blogue de Apache OpenOffice";
l10n.dl_share_light_blue_box_blog_src		= "/images/logo-rss-32.png";
l10n.dl_share_light_blue_box_blog_alt		= "Blogue";
l10n.dl_share_light_blue_box_facebook_text	= "Facebook";
l10n.dl_share_light_blue_box_facebook_title	= "Por favor, fale a les amistaes sobre Apache OpenOffice per Facebook";
...
l10n.dl_share_light_blue_box_twitter_title	= "Por favor, fale a les amistaes sobre Apache OpenOffice per Twitter";
...
l10n.dl_ext_blue_box_headline_text		= "Ver estensiones y diccionarios pa Apache OpenOffice";
l10n.dl_ext_blue_box_headline_title		= "Escoyer ente un bon rangu de funciones adicionales ya individuales";
l10n.dl_ext_blue_box_text_text			= "Enantar les funciones del so Apache OpenOffice con una creciente biblioteca d'estensiones y diccionarios d'otros usuarios.";
l10n.dl_ext_blue_box_text_title			= "Escoyer ente un bon rangu de funciones adicionales ya individuales";
...
l10n.dl_tlp_blue_box_headline_text		= "Ver plantíes pa Apache OpenOffice";
l10n.dl_tlp_blue_box_headline_title		= "Escoyer ente un bon rangu de documentos adicionales ya individuales";
l10n.dl_tlp_blue_box_text_text			= "Enantar la creatividá col so Apache OpenOffice con una creciente biblioteca de plantíes d'otros usuarios.";
l10n.dl_tlp_blue_box_text_title			= "Escoyer ente un bon rangu de documentos adicionales ya individuales";
...
l10n.dl_nav_sysreq_title			= "Discu: ~300MB llibres - Memoria: &gt;128MB - Procesador: &gt;500MHz - OS: Windows, macOS (OS&nbsp;X), Linux, Solaris, FreeBSD...";
l10n.dl_nav_sysreq_href				= "https://www.openoffice.org/dev_docs/source/sys_reqs_aoo41.html";
l10n.dl_nav_license_text			= "Llicencia";
l10n.dl_nav_license_title			= "Llicencia Apache OpenOffice";
l10n.dl_nav_license_href			= "https://www.openoffice.org/license.html";
l10n.dl_nav_source_text				= "Fonte";
l10n.dl_nav_source_title			= "Pa desendolcadores y usuarios avanzaos: Baxe la fonte pa construir Apache OpenOffice dende cero";
l10n.dl_nav_source_href				= "https://openoffice.apache.org/downloads.html";
l10n.dl_nav_build_text				= "Guía de construcción";
l10n.dl_nav_build_title				= "Pa desendolcadores y usuarios avanzaos: Guía Cómo pa construir Apache OpenOffice dende cero";
...
l10n.dl_nav_sdk_title				= "Pa desendolcadores: Software Development Kit";
...
l10n.dl_nav_schedule_text			= "Plan de llanzamientos actual";
l10n.dl_nav_schedule_title			= "¿Pa cuándo hai planeaos nuevos llanzamientos?";
...
l10n.dl_nav_inst_guide_title			= "Instrucciones pa instalar Apache OpenOffice en ordenadores con Windows, macOS (OS&nbsp;X) y Linux";
l10n.dl_nav_inst_guide_href			= "https://www.openoffice.org/download/common/instructions.html";
l10n.dl_nav_user_guide_text			= "Guíes del usuariu";
l10n.dl_nav_user_guide_title			= "Manuales del usuariu pal usu cotidianu";
...
l10n.dl_nav_why_java_title			= "Esplica por qué usar Java y qué ye";
...
l10n.dl_nav_support_text			= "Sofitu";
l10n.dl_nav_support_title			= "Si la información anterior nun respondió la entruga: ¡Sofitu de baldre y de pagu!";
l10n.dl_nav_support_href			= "https://www.openoffice.org/support/index.html";
l10n.dl_nav_local_text				= "Llocalizaciones";
l10n.dl_nav_local_title				= "Información y sofitu na so llingua favorita";
...
l10n.dl_nav_archive_text			= "Versiones antigües y archivaes";
l10n.dl_nav_archive_title			= "Descargar versiones antigües y archivaes";
