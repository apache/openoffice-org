...
teksturom, svetlosnim efektima, providnošću, perspektivom, i tako dalje.

*Pametni povezivači* (engl. connectors) skraćuju rad na dijagramima toka, organizacionim šemama, mrežnim
dijagramima, itd. Definišite svoje „tačke spajanja“ za povezivače da se „uhvate“.

*Dimenziona linija* automatski izračunava i prikazuje linearne dimenzije dok crtate.
...
*Uvezite grafike* svih uobičajenih formata (uključujući BMP, GIF, JPEG, PNG, TIFF,
i WMF).

Koristite besplatnu mogućnost **Crteža** da kreira Flash (.swf) verzije vašeg rada.
