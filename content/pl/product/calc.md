...
**Calc** jest arkuszem kalkulacyjnym którego zawsze chciałeś. Jest intuicyjny i łatwy
...
*DataPilot* jest zaawansowaną technologią, która ułatwia ściągać surowe dane z
korporacyjnych baz danych; tworzyć tabele krzyżowe; podsumowywać i zamieniać je
w konkretne informacje.

*Naturalne formuły językowe* pozwalają ci na tworzenie wzorów używając słów
(np. „obroty – koszty”).
...
komórki, włączając w to dowolne rotacje treścią, szablony, tła, obramowania i wiele
więcej. Możesz sam zostać ekspertem arkusza kalkulacyjnego dzięki *szablonom* z
wbudowanymi funkcjami, pozwalającymi ci skoncentrować się na twojej pracy.

*Menadżer scenariuszy* umożliwia analizę możliwych scenariuszy „co jeśli” za pomocą
...
w których optymalna wartość określonej komórki arkusza kalkulacyjnego musi być
...
może następnie z łatwością zintegrować nowe dane kilkoma kliknięciami. Ta funkcja
...
zapisać swoją pracę w formacie Excel, aby wysłać je do ludzi, którzy używają produktów
...
Jeśli zamierzasz wysłać swoje wyniki do kogoś kto nie posiada zainstalowanego programu
do arkuszy kalkulacyjnych, użyj Formatu Dokumentów Przenośnych PDF (.pdf) – aby to
