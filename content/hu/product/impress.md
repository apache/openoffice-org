...
megalkotásában. Bemutatóinak kiemelkedő része lesz a 2D és 3D clipart,
...
Emlékeztető az előadók és a közönség szükségleteinek kielégítésére, 
továbbá egy opcionális többoldalas nézet, hogy minden eszköz a keze ügyében legyen.
...
lehetővé teszi az Ön számára, hogy előre lássa a következő diáit, akárcsak az időt 
és előadói jegyzeteket.
...
'Rögzítse' leggyakrabban használt rajzeszközeit bárhol a képernyőn, hogy egyetlen 
...
képeket meghökkentő sebességel és élvezze a pozitív fogadtatást.

Mentse bemutatóit az új nemzetközi irodai dokumentumszabvány szerint OpenDocument formátumban.
Az XML alapú formátum használatával Ön nem lesz az **Impress** programhoz kötve. 
...
Készítse el bemutatóinak Flash (.swf) változatát az **Impress** saját, ingyenesen 
rendelkezésre álló funkciójával.

[1]: http://templates.openoffice.org "Apache OpenOffice sablonok letöltése"
[2]: http://extensions.openoffice.org/project/presenter-screen "Bemutató kezelő kiterjesztés letöltése"
