...
fájlba való letárolásával illetve teljes támogatást az egyszerű dBase fájlkohoz.

Nagyvállati felhasználók számára a **Base** teljes támogatást nyújt 
...
hogy Ön tulajdonképpen az összes létező adatbázisformtumhoz csatlakozni tudjon.
...
alkalmazásaihoz, mint például:
  ...
  - hivatkozással ellátott adattartományok átadása CALC fájlok részére kimutatás tábla és diagramok 
    készítéséhez.

A **Base** használatával kapcsolatos további információért látogassa meg az  
