...
való adatimportálást; táblákon belüli kereszthivatozásokat, összesítéseket és a kívánt információ előállítását.

A *Természetes nyelvű képletek* lehetővé teszik az egyszerű szavakkal történő 
képletbeírást (például "eladások - kiadások").

Az *Intelligens összesítő gomb* környezettől függően automatikusan alkalmazza
a végösszesen és részösszesen függvényeket.
...
ahol előregyrtott táblázatkezelési megoldásokkal segítjük munkájában.
...
munkafüzet tulajdonosa ezután könnyedén, néhány kattintásal integrálhatja az új adatot.
