...
kivitelezéseében is leveszik válláról a terhet, mint amilyen a körlevelek szerkesztése.
Természetesen szabadon megalkothatja saját sablonjait is, de [tölthet is le][1] a Kiterjesztések
közül.
...
Ha különböző nyelvek használatára van szüksége, a **Writer** azzal is megbírkózik.
...
ahogyan Ön megszerkesztette. 

Az Apache OpenOffice PDF export funkciója számos formázási és biztonsági beállítási opcióval 
rendelkezik, ezáltal a PDF fájlok a számos különböző felhasználási terület szerint testreszabhatók, 
...
A 3.0 verzió óta a **Writer** képes kezelni a Microsoft Office 2007 és Microsoft 
Office 2008 Mac OS X programokkal készült .docx fájlokat.
