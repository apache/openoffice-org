...
<text:outline-style>
	...
	<office:automatic-styles>
		...
		<style:style style:name="Sect1" style:family="section">
			<style:properties  fo:font-size="18pt">
		...
		<style:style style:name="ArticleInfo" style:family="section">
			<style:properties  fo:font-size="18pt">
				<style:columns fo:column-count="1" fo:column-gap="0cm">
					<style:column style:rel-width="65535*" fo:margin-left="0cm" fo:margin-right="0cm" />
				</style:columns>
			...
			<style:style style:name="Appendix" style:family="section">
			<style:properties  fo:font-size="18pt">
				<style:columns fo:column-count="1" fo:column-gap="0cm">
					<style:column style:rel-width="65535*" fo:margin-left="0cm" fo:margin-right="0cm" />
				</style:columns>
		...
		<text:list-style style:name="Ordered List">
			<text:list-level-style-number text:level="1" text:style-name="Numbering Symbols" style:num-suffix="." style:num-format="1" ><style:properties text:min-label-width="0.499cm" ></style:properties>
</text:list-level-style-number>
<text:list-level-style-number text:level="2" style:num-suffix="." style:num-format="1" ><style:properties text:space-before="0.501cm" text:min-label-width="0.499cm" ></style:properties>
</text:list-level-style-number>
<text:list-level-style-number text:level="3" style:num-suffix="." style:num-format="1" ><style:properties text:space-before="1cm" text:min-label-width="0.499cm" ></style:properties>
</text:list-level-style-number>
<text:list-level-style-number text:level="4" style:num-suffix="." style:num-format="1" ><style:properties text:space-before="1.501cm" text:min-label-width="0.499cm" ></style:properties>
</text:list-level-style-number>
<text:list-level-style-number text:level="5" style:num-suffix="." style:num-format="1" ><style:properties text:space-before="2cm" text:min-label-width="0.499cm" ></style:properties>
</text:list-level-style-number>
<text:list-level-style-number text:level="6" style:num-suffix="." style:num-format="1" ><style:properties text:space-before="2.501cm" text:min-label-width="0.499cm" ></style:properties>
</text:list-level-style-number>
<text:list-level-style-number text:level="7" style:num-suffix="." style:num-format="1" ><style:properties text:space-before="3.001cm" text:min-label-width="0.499cm" ></style:properties>
</text:list-level-style-number>
<text:list-level-style-number text:level="8" style:num-suffix="." style:num-format="1" ><style:properties text:space-before="3.502cm" text:min-label-width="0.499cm" ></style:properties>
</text:list-level-style-number>
<text:list-level-style-number text:level="9" style:num-suffix="." style:num-format="1" ><style:properties text:space-before="4.001cm" text:min-label-width="0.499cm" ></style:properties>
</text:list-level-style-number>
<text:list-level-style-number text:level="10" style:num-suffix="." style:num-format="1" ><style:properties text:space-before="4.502cm" text:min-label-width="0.499cm" ></style:properties>
</text:list-level-style-number>
		</text:list-style>
<text:list-style style:name="Var List" ><text:list-level-style-bullet text:level="1" text:style-name="Bullet Symbols" text:bullet-char="" ><style:properties text:min-label-width="0.499cm" ></style:properties>
</text:list-level-style-bullet>
<text:list-level-style-number text:level="2" style:num-suffix="." style:num-format="1" ><style:properties text:space-before="0.501cm" text:min-label-width="0.499cm" ></style:properties>
</text:list-level-style-number>
<text:list-level-style-number text:level="3" style:num-suffix="." style:num-format="1" ><style:properties text:space-before="1cm" text:min-label-width="0.499cm" ></style:properties>
...
<text:list-level-style-number text:level="10" style:num-suffix="." style:num-format="1" ><style:properties text:space-before="4.502cm" text:min-label-width="0.499cm" ></style:properties>
		...
		<text:list-style style:name="UnOrdered List" ><text:list-level-style-bullet text:level="1" text:style-name="Bullet Symbols" text:bullet-char="" ><style:properties text:min-label-width="0.499cm" style:font-name="StarSymbol" ></style:properties></text:list-level-style-bullet>
			<text:list-level-style-bullet text:level="2" text:style-name="Bullet Symbols" text:bullet-char="" ><style:properties text:min-label-width="0.499cm" style:font-name="StarSymbol" style:font-charset="x-symbol"  ></style:properties></text:list-level-style-bullet>
			
			<text:list-level-style-bullet text:level="3" text:style-name="Bullet Symbols" text:bullet-char="" ><style:properties text:space-before="1cm" text:min-label-width="0.499cm" style:font-name="StarSymbol" ></style:properties>
			</text:list-level-style-bullet>
<text:list-level-style-bullet text:level="4" text:style-name="Bullet Symbols" text:bullet-char="" ><style:properties text:space-before="1.501cm" text:min-label-width="0.499cm" style:font-name="StarSymbol" ></style:properties>
</text:list-level-style-bullet>
<text:list-level-style-bullet text:level="5" text:style-name="Bullet Symbols" text:bullet-char="" ><style:properties text:space-before="2cm" text:min-label-width="0.499cm" style:font-name="StarSymbol" ></style:properties>
</text:list-level-style-bullet>
<text:list-level-style-bullet text:level="6" text:style-name="Bullet Symbols" text:bullet-char="" ><style:properties text:space-before="2.501cm" text:min-label-width="0.499cm" style:font-name="StarSymbol" ></style:properties>
</text:list-level-style-bullet>
<text:list-level-style-bullet text:level="7" text:style-name="Bullet Symbols" text:bullet-char="" ><style:properties text:space-before="3.001cm" text:min-label-width="0.499cm" style:font-name="StarSymbol" ></style:properties>
</text:list-level-style-bullet>
<text:list-level-style-bullet text:level="8" text:style-name="Bullet Symbols" text:bullet-char="" ><style:properties text:space-before="3.502cm" text:min-label-width="0.499cm" style:font-name="StarSymbol" ></style:properties>
</text:list-level-style-bullet>
<text:list-level-style-bullet text:level="9" text:style-name="Bullet Symbols" text:bullet-char="" ><style:properties text:space-before="4.001cm" text:min-label-width="0.499cm" style:font-name="StarSymbol" ></style:properties>
</text:list-level-style-bullet>
<text:list-level-style-bullet text:level="10" text:style-name="Bullet Symbols" text:bullet-char="" ><style:properties text:space-before="4.502cm" text:min-label-width="0.499cm" style:font-name="StarSymbol" ></style:properties>
</text:list-level-style-bullet>
</text:list-style>
		...
		<xsl:element name="text:p">				
			<xsl:choose>	
				<xsl:when test="parent::sect1">
								 <xsl:attribute name="text:style-name">Section1 Title</xsl:attribute>	 
				</xsl:when>
				<xsl:when test="parent::sect2">
					 <xsl:attribute name="text:style-name">Section2 Title</xsl:attribute>	 
				</xsl:when>
				<xsl:when test="parent::sect3">
					 <xsl:attribute name="text:style-name">Section3 Title</xsl:attribute>	 
				</xsl:when>
				...
				<xsl:otherwise>
					<xsl:attribute name="text:style-name">Section Title</xsl:attribute>
				</xsl:otherwise>
		 	</xsl:choose>
			<xsl:apply-templates/>
		</xsl:element>
...
<xsl:template match="abstract">
	<xsl:element name="text:section">
		<xsl:attribute name="text:style-name">Abstract</xsl:attribute> 
		<xsl:attribute name="text:name">Abstract</xsl:attribute>
		<xsl:apply-templates/>
	</xsl:element>
</xsl:template>
