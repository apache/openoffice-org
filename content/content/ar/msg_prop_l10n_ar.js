...
l10n.index_alert_box_text_text			= "This note is in English because we have no one to translate it into your language. The links on this page will help you download and install all other available versions of Apache OpenOffice.<br />We would be happy to make Apache OpenOffice available in Arabic, but we need help completing the translation of the user interface.<br /><br /> If you are interested in helping translate, please click this text to review the information. You can send a note to our mailing list \"L10N@openoffice.apache.org\" if you want to volunteer or if you have questions.";
