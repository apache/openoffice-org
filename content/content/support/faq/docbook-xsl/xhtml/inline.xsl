...
<!-- ********************************************************************
     $Id: inline.xsl,v 1.1 2003/08/21 00:15:46 cphennessy Exp $
     ********************************************************************
...
<xsl:template name="inline.charseq">
  ...
  <span xmlns="http://www.w3.org/1999/xhtml" class="{local-name(.)}"><xsl:copy-of select="$content"/></span>
</xsl:template>
...
<xsl:template name="inline.monoseq">
  ...
  <tt xmlns="http://www.w3.org/1999/xhtml" class="{local-name(.)}"><xsl:copy-of select="$content"/></tt>
</xsl:template>
...
<xsl:template name="inline.boldseq">
  ...
  <xsl:choose>
    ...
    <xsl:otherwise>
      <b xmlns="http://www.w3.org/1999/xhtml" class="{local-name(.)}"><xsl:copy-of select="$content"/></b>
    </xsl:otherwise>
  </xsl:choose>
</xsl:template>
...
<xsl:template name="inline.italicseq">
  ...
  <i xmlns="http://www.w3.org/1999/xhtml" class="{local-name(.)}"><xsl:copy-of select="$content"/></i>
</xsl:template>
...
<xsl:template name="inline.boldmonoseq">
  ...
  <xsl:choose>
    ...
    <xsl:otherwise>
      <b xmlns="http://www.w3.org/1999/xhtml" class="{local-name(.)}"><tt><xsl:copy-of select="$content"/></tt></b>
    </xsl:otherwise>
  </xsl:choose>
</xsl:template>
...
<xsl:template name="inline.italicmonoseq">
  ...
  <i xmlns="http://www.w3.org/1999/xhtml" class="{local-name(.)}"><tt><xsl:copy-of select="$content"/></tt></i>
</xsl:template>
...
<xsl:template match="foreignphrase">
  <span xmlns="http://www.w3.org/1999/xhtml" class="foreignphrase">
...
<xsl:template match="lineannotation">
  <i xmlns="http://www.w3.org/1999/xhtml" class="{local-name(.)}">
    <xsl:call-template name="inline.charseq"/>
  </i>
</xsl:template>
