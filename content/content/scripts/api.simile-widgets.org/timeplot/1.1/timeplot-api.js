...
(function() {
    ...
    var loadTimeline = function() {
        if (typeof Timeline != "undefined") {
            ...
            var timelineURL = "/scripts/api.simile-widgets.org/timeline/2.3.1/timeline-api.js?bundle=true";
    ...
    if (typeof SimileAjax == "undefined") {
        ...
        var url = "/scripts/api.simile-widgets.org/ajax/2.2.1/simile-ajax-api.js?bundle=true";
