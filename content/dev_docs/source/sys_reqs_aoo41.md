type=page
title=System Requirements for Apache OpenOffice 4.1.x
...
- Java runtime environment 1.5.x or newer

### Linux:

- Installation of GNOME 2.10 or higher

****

Also see [Index of System Requirements for each version][3].
