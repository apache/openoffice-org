...
// General:
l10n.dl_headline_text				= "Stáhnout Apache OpenOffice";

// Download: Strings in the green box (used in "index.html").
l10n.dl_green_box_headline_text			= "Stáhnout Apache OpenOffice";
l10n.dl_green_box_headline_title		= "Stáhnout Apache OpenOffice";
l10n.dl_green_box_subtext1_text			= "Poskytuje SourceForge.net - důvěryhodná webstránka";
l10n.dl_green_box_subtext1_title		= "Binární soubory Apache OpenOffice poskytuje SourceForge.net - důvěryhodná webstránka";
l10n.dl_green_box_subtext2_text			= "Vyberte svůj oblíbený operační systém, jazyk a verzi ";
l10n.dl_green_box_subtext2_title		= "Vyberte svůj oblíbený operační systém, jazyk a verzi ";
l10n.dl_green_box_selectbox_os_title		= "Vyberte si svůj oblíbený operační systém ";
l10n.dl_green_box_selectbox_lang_title		= "Vyberte si svůj oblíbený jazyk ";
l10n.dl_green_box_selectbox_ver_title		= "Vyberte si svou oblíbenou verzi";
...
l10n.dl_share_light_blue_box_headline_text	= "Pomozte šířit";
l10n.dl_share_light_blue_box_headline_title	= "Pomozte sířit Apache OpenOffice a řekněte o něm svým přátelům";
l10n.dl_share_light_blue_box_text_text		= "Prosím řekněte svým přátelům o Apache OpenOffice:";
l10n.dl_share_light_blue_box_text_title		= "Pomozte sířit Apache OpenOffice a řekněte o něm svým přátelům";
...
l10n.dl_share_light_blue_box_facebook_title	= "Prosím řekněte svým přátelům o o Apache OpenOffice cez Facebook";
...
l10n.dl_share_light_blue_box_twitter_title	= "Prosím řekněte svým přátelům o o Apache OpenOffice cez Twitter";
...
l10n.dl_ext_blue_box_headline_text		= "Získat Apache OpenOffice rozšíření a slovníky";
l10n.dl_ext_blue_box_headline_title		= "Vyberte si ze široké škály přídavných a originálních funkcí";
l10n.dl_ext_blue_box_text_text			= "Rozšiřte funkce svého Apache OpenOffice s velkou a stále se rozrůstající knihovnou rozšíření a slovníků od ostatních uživatelů.";
l10n.dl_ext_blue_box_text_title			= "Vyberte si ze široké škály přídavných a originálních funkcí";
...
l10n.dl_tlp_blue_box_headline_text		= "Získat Apache OpenOffice šablony";
l10n.dl_tlp_blue_box_headline_title		= "Vyberte si ze široké škály přídavných a originálních dokumentů";
l10n.dl_tlp_blue_box_text_text			= "Rozšiřte kreativitu svojho Apache OpenOffice s velkou a stále se rozrůstající knihovnou šablon od ostatních uživatelů.";
l10n.dl_tlp_blue_box_text_title			= "Vyberte si ze široké škály přídavných a originálních dokumentů";
...
l10n.dl_nav_sysreq_text				= "Systémové požadavky";
...
l10n.dl_nav_schedule_text			= "Aktuální plán vydaní";
l10n.dl_nav_schedule_title			= "Kdy jsou plánované nové vydání?";
...
l10n.dl_nav_hist_schedule_title			= "Kdy byly naplánovány staré vydaní?";
...
l10n.dl_nav_why_java_title			= "Vysvětluje proč použít Java a co to je";
l10n.dl_nav_why_java_href			= "https://www.openoffice.org/download/common/java.html";
l10n.dl_nav_eol_text				= "End-Of-Life informace";
l10n.dl_nav_eol_title				= "Informace o vydáních, které dosáhly stav End-Of-Life";
...
l10n.dl_nav_support_title			= "Pokud vám výše uvedené informace nedaly odpověď na vaši otázku: Podpora placená i zdarma!";
...
l10n.dl_error_please_select_3_text		= "Please select a download for Windows, Linux or macOS (OS&nbsp;X).";
