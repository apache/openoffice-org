...
l10n.dl_platform_info_linux_text		= "<h5> RPM vs. DEB - Que choisir ? </h5> <p> RPM est utilisé dans: <br/> CentOS, Fedora, Mageia, Mandriva, MeeGo, openSUSE, Oracle Linux, PCLinuxOS, Red Hat Enterprise Linux, Sailfish OS, Scientific Linux, SUSE Linux Enterprise Server <br /><br /> DEB est utilisé dans <br/> Debian, Kanotix, Knoppix, Kubuntu, Linux Mint, Lubuntu, Ubuntu, Xubuntu </p> <h5> Instructions d'installation </h5> <p>Pour les instructions d'installation voir ici : <a target='_blank' href=https://www.openoffice.org/download/common/instructions.html#linux>https://www.openoffice.org/download/common/instructions.html#linux</a>.</p>";
...
l10n.dl_checksum_keys_title			= "KEYS fichier signature";
l10n.dl_checksum_asc_text			= "ASC";
l10n.dl_checksum_asc_title			= "ASC signature pour : ";
l10n.dl_checksum_md5_text			= "MD5";
l10n.dl_checksum_md5_title			= "MD5 hash pour : ";
l10n.dl_checksum_sha256_text			= "SHA256";
l10n.dl_checksum_sha256_title			= "SHA256 hash pour : ";
l10n.dl_checksum_sha512_text			= "SHA512";
l10n.dl_checksum_sha512_title			= "SHA512 hash pour : ";
...
l10n.dl_checksum_title				= "Comment vérifier le fichier téléchargé avec des sommes de contrôle";
l10n.dl_report_img_title			= "Lien de téléchargement rompu? Cliquez ici pour le signaler.";
...
l10n.dl_full_link_error_text			= "Aucune installation complète disponible";
l10n.dl_full_link_error_title			= "Veuillez sélectionner une autre langue, plate-forme ou version.";
l10n.dl_langpack_link_error_text		= "Aucun pack de langue disponible";
l10n.dl_langpack_link_error_title		= "Veuillez sélectionner une autre langue, plate-forme ou version.";

l10n.dl_error_problem_img_title			= "Le fichier de téléchargement sélectionné n'est pas disponible";
l10n.dl_error_problem_img_src			= "/download/cachedimages/exclamation-icon.png";
l10n.dl_error_problem_img_alt			= "Texte d'erreur";
l10n.dl_error_problem_text			= "Problème : ";
l10n.dl_error_solution_text			= "Solution : ";
l10n.dl_error_aoo_text				= "Apache OpenOffice ";
l10n.dl_error_not_available_for_text		= " n'est pas disponible pour ";
l10n.dl_error_please_select_1_text		= "Veuillez sélectionner la version 4.0.1.";
l10n.dl_error_please_select_2_text		= "Veuillez sélectionner la version 4.1.0 ou une version plus récente.";
l10n.dl_error_please_select_3_text		= "Veuillez sélectionner un téléchargement pour Windows, macOS (OS&nbsp;X) ou Linux.";
l10n.dl_error_please_select_4_text		= "Veuillez sélectionner une autre langue ou version.";
...
l10n.dl_analyze_instruction_select_text		= "<b>Sélectionnez vos </b> : système d'exploitation, langue et version favoris dans la case verte ci-dessous.";
l10n.dl_analyze_instruction_verify_text		= "Vérifiez que ces options <b>ne conduisent toujours pas</b> à des liens de téléchargement valides.";
l10n.dl_analyze_instruction_click_text		= "Cliquez sur le bouton sous la case verte :";
l10n.dl_analyze_instruction_copy_text		= "Copiez les données de la table sélectionnée dans le presse-papiers :";
l10n.dl_analyze_instruction_new_mail_text	= "Créer un nouveau courrier.";
l10n.dl_analyze_instruction_problem_text	= "<b>Rédigez une description du problème</b> (ce qui ne fonctionne pas et à quoi vous attendez-vous).";
l10n.dl_analyze_instruction_details_text	= "Veuillez également ajouter <b>des détails sur le système d'exploitation utilisé</b>.";
l10n.dl_analyze_instruction_paste_text		= "Collez les données copiées à la fin du courrier.";
l10n.dl_analyze_instruction_only_download_text	= "Veuillez <b>envoyer le courrier uniquement en cas de problèmes de téléchargement</b> et non si vous ne pouvez pas installer.";
l10n.dl_analyze_instruction_no_install_text	= "Cette page Web ne peut pas du tout résoudre les problèmes d'installation.";
l10n.dl_analyze_instruction_send_mail_text	= "Enfin, <b>envoyer le courrier</b> à : ";
l10n.dl_analyze_instruction_mailing_list_text	= "Apache OpenOffice Development Mailing List";
l10n.dl_analyze_instruction_mailing_list_title	= "Envoyer le rapport sur la liste de diffusion des développeurs Apache OpenOffice";
l10n.dl_analyze_instruction_learn_more_text	= "Cliquez ici pour en savoir plus sur ce qu'est une liste de diffusion";
l10n.dl_analyze_instruction_learn_more_title	= "En savoir plus sur ce qu'est une liste de diffusion";
l10n.dl_analyze_instruction_answer_text		= "Nous essaierons de répondre dès que nous aurons reçu le courrier et analysé le problème.";
l10n.dl_analyze_instruction_thanks_text		= "Nous vous remercions pour votre rapport.";

// Analyze: Strings for the 3 buttons (used in "analyze.html").
l10n.dl_analyze_update_button_text		= "Cliquez pour mettre à jour le tableau";
l10n.dl_analyze_update_button_title		= "Mettez les options sélectionnées en tant que valeurs dans le tableau ci-dessous";
l10n.dl_analyze_select_button_text		= "Cliquez pour sélectionner le tableau";
l10n.dl_analyze_select_button_title		= "Sélectionnez toutes les données dans le tableau ci-dessous";
l10n.dl_analyze_copy_button_text		= "Copier avec [Ctrl]+[C] / [&#8984;]+[C]";
l10n.dl_analyze_copy_button_title		= "Copiez les données de la table sélectionnée via [ Ctrl ] + [ C ] or [ &#8984; ] + [ C ]dans le presse-papiers";

// Analyze: Strings for the table (used in "analyze.html").
l10n.dl_analyze_table_problem_text1		= "Description du problème";
l10n.dl_analyze_table_problem_text2		= "Remplacez ce texte pour décrire le problème <br /><br />(Qu'est-ce qui ne fonctionne pas ? À quoi vous attendez-vous ?)";
l10n.dl_analyze_table_browser_text		= "Variables du navigateur";
l10n.dl_analyze_table_values_text		= "Valeurs";
l10n.dl_analyze_table_yes_text			= "Oui";
l10n.dl_analyze_table_no_text			= "Non";
l10n.dl_analyze_table_stable_release_text	= "Version stable";
l10n.dl_analyze_table_javascript_text		= "JavaScript&nbsp;fonctions/variables";
