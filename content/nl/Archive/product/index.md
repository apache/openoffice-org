...
![Apache OpenOffice?](/images/AOO_logos/orb.jpg) # {.rfloatimg}
  ...
  - [Calc](calc.html "Spreadsheet") a powerful spreadsheet with all the tools
    you need to calculate, analyse, and present your data in numerical reports
...
- Apache OpenOffice is supported by a global community of friendly volunteers,
  only too happy to provide assistance to newcomers and advanced users alike
...
- certified by [OSI][5] as open-standard compliant, and the first software
  package in the world to use [OASIS][6] [OpenDocument Format][7] (ISO 26300)
