...
l10n.dl_platform_info_win_text			= "<h5> 32 bitai, 64 bitai ir Java – ką rinktis? </h5> <p> Šiuo metu platformai „Windows“ siūloma 32 bitų (x86) laida, veikianti ir „Windows“ 64 bitų (x86-64) architektūroje. Įsidėmėtina, kad papildomoms funkcijoms gali reikėti 32 bitų Javos, pasirinktinos meniu „Priemonės – Nuostatos… – OpenOffice – Java“. <br /><br /> Daugiau informacijos apie „OpenOffice“ ir Javą žr. <a target='_blank' href=https://www.openoffice.org/download/common/java.html>https://www.openoffice.org/download/common/java.html</a>.</p>";
...
l10n.dl_platform_info_linux_text		= "<h5> RPM lyginant su DEB – kurį rinktis? </h5> <p> RPM vartojamas: <br/> CentOS, Fedora, Mageia, Mandriva, MeeGo, openSUSE, Oracle Linux, PCLinuxOS, Red Hat Enterprise Linux, Sailfish OS, Scientific Linux, SUSE Linux Enterprise Server. <br /><br /> DEB vartojamas: <br/> Debian, Kanotix, Knoppix, Kubuntu, Linux Mint, Lubuntu, Ubuntu, Xubuntu. </p> <h5> Diegimas </h5> <p>Diegimo instrukciją žr. <a target='_blank' href=https://www.openoffice.org/download/common/instructions.html#linux>https://www.openoffice.org/download/common/instructions.html#linux</a>.</p>";
