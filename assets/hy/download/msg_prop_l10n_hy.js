...
l10n.dl_green_box_select_box_version_older	= "Հին թողարկումներ";
...
l10n.dl_platform_info_win_text			= "<h5> 32-բիթ, 64-բիթ և Java - Ո՞րը ընտրել։ </h5> <p> Այս պահին մենք առաջարկում ենք 32-բիթ (x86) տարբերակը Windows-ի համար։ Այնուամենայնիվ, այն տեղադրվում և գործարկվում է նաև Windows 64-բիթով (x86-64)։ Խնդրում ենք նկատի ունենալ, որ լրացուցիչ ֆունկցիոնալության համար ձեզ կարող է անհրաժեշտ լինել 32-բիթանոց Java , որն այնուհետև պետք է ընտրվի միայն մեկ անգամ (տե՛ս 'Գործիքներ - Ընտրանքներ - OpenOffice - Java'  ընտրացանկը )։ <br /><br /> OpenOffice-ի և Java-ի մասին լրացուցիչ տեղեկություններ ստանալու համար տե՛ս: <a target='_blank' href=https://www.openoffice.org/download/common/java.html>https://www.openoffice.org/download/common/java.html</a>.</p>";
