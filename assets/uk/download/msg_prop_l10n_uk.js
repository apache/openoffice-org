...
// Змініть хх до чинного ISO коду мови.
DL.NL_LANG = "en-US";
...
// Якщо залишити типове значення, вікно завантаження для будь-якої ОС, мови чи випуску буде показано на:
// http://www.openoffice.org/download/index.html
// Налаштування кожного з цих масивів вимагатиме постійної актуалізації з виходом нових випусків.
